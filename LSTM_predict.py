...
# import function defined earlier in LSTM_train.py
#function load_process_data just reads data from csv, drops duplicates, 
# converts to datatime and sorts by date
from LSTM_train import load_process_data

# slightly modified from get_pred_closing_price() from LSTM_train.py
def pred_closing_price(df, scaler, model):
    ...
    #inverse transform data from standardized to actual values
